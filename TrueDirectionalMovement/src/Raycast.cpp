...
namespace Raycast
{
	...
	void RayHitCollector::AddRayHit([[maybe_unused]] const ConsoleRE::hkpCdBody& cdBody, const ConsoleRE::hkpShapeRayCastCollectorOutput& hitInfo)
	{
	...
	//void AllRayHitCollector::AddRayHit(const ConsoleRE::hkpCdBody& cdBody, [[maybe_unused]] const ConsoleRE::hkpShapeRayCastCollectorOutput& hitInfo)
	//{
	//	// Note: for optimization purposes this should set the m_earlyOutHitFraction to:
	//	// - 0.0 if you want to get no more hits
	//	// - 1.0 if you want to get all hits (constructor initializes this value to 1.0 by default)
	...
	//	ConsoleRE::hkpCdBody* body = const_cast<ConsoleRE::hkpCdBody*>(&cdBody);
	//	while (body->parent) {
	//		body = const_cast<ConsoleRE::hkpCdBody*>(body->parent);
	//	}
