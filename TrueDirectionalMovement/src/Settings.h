...
enum DirectionalMovementMode : uint32_t
{
	kDisabled = 0,
	kVanilla = 1,
	kDirectional = 2
...
enum TargetLockProjectileAimType : uint32_t
{
	kFreeAim = 0,
	kPredict = 1,
	kHoming = 2
...
enum class DialogueMode : uint32_t
{
	kDisable = 0,
	kNormal = 1,
	kFaceSpeaker = 2
...
enum class CameraHeadtrackingMode : uint32_t
{
	kDisable = 0,
	kNormal = 1,
	kFaceCamera = 2
...
enum class CameraAdjustMode : uint32_t
{
	kDisable = 0,
	kDuringSprint = 1,
	kAlways = 2
...
enum class ReticleStyle : uint32_t
{
	kCrosshair = 0,
...
enum class WidgetAnchor : uint32_t
{
	kBody = 0,
	kHead = 1,
};
...
struct Settings
{
	...
	// Keys
	static inline uint32_t uTargetLockKey = 0x00000040;
	...
	// Non-MCM
	static inline std::unordered_map<ConsoleRE::BGSBodyPartData*, std::vector<std::string>> targetPoints;

	static inline ConsoleRE::BGSKeyword* kywd_magicWard = nullptr;
	static inline ConsoleRE::BGSKeyword* kywd_furnitureForces1stPerson = nullptr;
	static inline ConsoleRE::BGSKeyword* kywd_furnitureForces3rdPerson = nullptr;
	static inline ConsoleRE::SpellItem* spel_targetLockSpell = nullptr;
	static inline ConsoleRE::TESGlobal* glob_directionalMovement = nullptr;
	static inline ConsoleRE::TESGlobal* glob_targetLockHint = nullptr;
	static inline ConsoleRE::TESGlobal* glob_trueHUD = nullptr;
	static inline ConsoleRE::TESGlobal* glob_nemesisHeadtracking = nullptr;
	static inline ConsoleRE::TESGlobal* glob_nemesisMountedArchery = nullptr;
	static inline ConsoleRE::TESGlobal* glob_nemesisLeaning = nullptr;
};
