...
namespace TRUEHUD_API
{
	...
	enum class PlayerWidgetBarType : uint8_t
	{
		HealthBar,
		MagickaBar,
		StaminaBar,
	...
	using SpecialResourceCallback = std::function<float(ConsoleRE::Actor* a_actor)>;
	...
	public:
		...
		WidgetBase(ConsoleRE::GPtr<ConsoleRE::GFxMovieView> a_view) :
			_view(a_view),
			_widgetID(0)
		{}
		...
		WidgetBase(ConsoleRE::GPtr<ConsoleRE::GFxMovieView> a_view, uint32_t a_widgetID) :
			_view(a_view),
			_widgetID(a_widgetID)
		{}
	...
	public:
		...
		[[nodiscard]] virtual APIResult RequestTargetControl(size_t a_myPluginHandle) noexcept = 0;
		...
		/// <param name="a_myPluginHandle">Your assigned plugin handle</param>
		/// <returns>OK, AlreadyGiven, AlreadyTaken</returns>
		[[nodiscard]] virtual APIResult RequestSpecialResourceBarsControl(size_t a_myPluginHandle) noexcept = 0;
		...
		virtual APIResult SetTarget(size_t a_myPluginHandle, ConsoleRE::ActorHandle a_actorHandle) noexcept = 0;
		...
		/// <param name="a_myPluginHandle">Your assigned plugin handle</param>
		/// <returns>OK, NotOwner</returns>
		virtual APIResult SetSoftTarget(size_t a_myPluginHandle, ConsoleRE::ActorHandle a_actorHandle) noexcept = 0;

		/// <summary>
		/// Tries to create an info bar widget for the given actor handle.
		/// </summary>
		/// <param name="a_actorHandle">Actor handle</param>
		virtual void AddActorInfoBar(ConsoleRE::ActorHandle a_actorHandle) noexcept = 0;
		...
		virtual void RemoveActorInfoBar(ConsoleRE::ActorHandle a_actorHandle, WidgetRemovalMode a_removalMode) noexcept = 0;

		/// <summary>
		/// Adds an actor handle to the boss queue.
		/// </summary>
		/// <param name="a_actorHandle">Actor handle</param>
		virtual void AddBoss(ConsoleRE::ActorHandle a_actorHandle) noexcept = 0;
		...
		/// <param name="a_actorHandle">Actor handle</param>
		/// <param name="a_removalMode">How quickly should the widget be removed</param>
		virtual void RemoveBoss(ConsoleRE::ActorHandle a_actorHandle, WidgetRemovalMode a_removalMode) noexcept = 0;
		...
		virtual void FlashActorValue(ConsoleRE::ActorHandle a_actorHandle, ConsoleRE::ActorValue a_actorValue, bool a_bLong) noexcept = 0;
		...
		/// <param name="a_bLong">Play longer flash animation</param>
		/// <returns>OK, NotOwner</returns>
		virtual APIResult FlashActorSpecialBar(size_t a_myPluginHandle, ConsoleRE::ActorHandle a_actorHandle, bool a_bLong) noexcept = 0;
		...
		/// <returns>OK, NotOwner</returns>
		virtual APIResult RegisterSpecialResourceFunctions(size_t a_myPluginHandle, SpecialResourceCallback&& a_getCurrentSpecialResource, SpecialResourceCallback&& a_getMaxSpecialResource, bool a_bSpecialMode, bool a_bDisplaySpecialForPlayer = true) noexcept = 0;
		...
		virtual void LoadCustomWidgets(size_t a_myPluginHandle, const char* a_filePath, APIResultCallback&& a_successCallback) noexcept = 0;
		...
		virtual void RegisterNewWidgetType(size_t a_myPluginHandle, uint32_t a_widgetType) noexcept = 0;
		...
		virtual void AddWidget(size_t a_myPluginHandle, uint32_t a_widgetType, uint32_t a_widgetID, const char* a_symbolIdentifier, std::shared_ptr<WidgetBase> a_widget) noexcept = 0;
		...
		virtual void RemoveWidget(size_t a_myPluginHandle, uint32_t a_widgetType, uint32_t a_widgetID, WidgetRemovalMode a_removalMode) noexcept = 0;

		/// <summary>
		/// Returns the plugin handle of the plugin controlling the current target resource.
		/// </summary>
		/// <returns>Handle or ksize_t_Invalid if no one currently owns the resource</returns>
		virtual size_t GetTargetControlOwner() const noexcept = 0;

		/// <summary>
		/// Returns the plugin handle of the plugin controlling player widget bar colors.
		/// </summary>
		/// <returns>Handle or ksize_t_Invalid if no one currently owns the resource</returns>
		virtual size_t GetPlayerWidgetBarColorsControlOwner() const noexcept = 0;

		/// <summary>
		/// Returns the plugin handle of the plugin controlling special resource bars.
		/// </summary>
		/// <returns>Handle or ksize_t_Invalid if no one currently owns the resource</returns>
		virtual size_t GetSpecialResourceBarControlOwner() const noexcept = 0;
		...
		/// <param name="a_myPluginHandle">Your assigned plugin handle</param>
		/// <returns>OK, NotOwner</returns>
		virtual APIResult ReleaseTargetControl(size_t a_myPluginHandle) noexcept = 0;
		...
		/// <param name="a_myPluginHandle">Your assigned plugin handle</param>
		/// <returns>OK, NotOwner</returns>
		virtual APIResult ReleaseSpecialResourceBarControl(size_t a_myPluginHandle) noexcept = 0;
	};
	...
	public:
		...
		virtual void OverrideBarColor(ConsoleRE::ActorHandle a_actorHandle, ConsoleRE::ActorValue a_actorValue, BarColorType a_colorType, uint32_t a_color) noexcept = 0;
		...
		/// <param name="a_colorType">Which color you want to override</param>
		/// <param name="a_color">The color in hex</param>
		virtual void OverrideSpecialBarColor(ConsoleRE::ActorHandle a_actorHandle, BarColorType a_colorType, uint32_t a_color) noexcept = 0;
		...
		virtual void RevertBarColor(ConsoleRE::ActorHandle a_actorHandle, ConsoleRE::ActorValue a_actorValue, BarColorType a_colorType) noexcept = 0;
		...
		/// <param name="a_actorHandle">Actor handle</param>
		/// <param name="a_colorType">Which color you want to revert</param>
		virtual void RevertSpecialBarColor(ConsoleRE::ActorHandle a_actorHandle, BarColorType a_colorType) noexcept = 0;
	};
	...
	public:
		...
		virtual void DrawLine(const ConsoleRE::NiPoint3& a_start, const ConsoleRE::NiPoint3& a_end, float a_duration = 0.f, uint32_t a_color = 0xFF0000FF, float a_thickness = 1.f) noexcept = 0;
		virtual void DrawPoint(const ConsoleRE::NiPoint3& a_position, float a_size, float a_duration = 0.f, uint32_t a_color = 0xFF0000FF) noexcept = 0;
		virtual void DrawArrow(const ConsoleRE::NiPoint3& a_start, const ConsoleRE::NiPoint3& a_end, float a_size = 10.f, float a_duration = 0.f, uint32_t a_color = 0xFF0000FF, float a_thickness = 1.f) noexcept = 0;
		virtual void DrawBox(const ConsoleRE::NiPoint3& a_center, const ConsoleRE::NiPoint3& a_extent, const ConsoleRE::NiQuaternion& a_rotation, float a_duration = 0.f, uint32_t a_color = 0xFF0000FF, float a_thickness = 1.f) noexcept = 0;
		virtual void DrawCircle(const ConsoleRE::NiPoint3& a_center, const ConsoleRE::NiPoint3& a_x, const ConsoleRE::NiPoint3& a_y, float a_radius, uint32_t a_segments, float a_duration = 0.f, uint32_t a_color = 0xFF0000FF, float a_thickness = 1.f) noexcept = 0;
		virtual void DrawHalfCircle(const ConsoleRE::NiPoint3& a_center, const ConsoleRE::NiPoint3& a_x, const ConsoleRE::NiPoint3& a_y, float a_radius, uint32_t a_segments, float a_duration = 0.f, uint32_t a_color = 0xFF0000FF, float a_thickness = 1.f) noexcept = 0;
		virtual void DrawSphere(const ConsoleRE::NiPoint3& a_origin, float a_radius, uint32_t a_segments = 16, float a_duration = 0.f, uint32_t a_color = 0xFF0000FF, float a_thickness = 1.f) noexcept = 0;
		virtual void DrawCylinder(const ConsoleRE::NiPoint3& a_start, const ConsoleRE::NiPoint3& a_end, float a_radius, uint32_t a_segments, float a_duration = 0.f, uint32_t a_color = 0xFF0000FF, float a_thickness = 1.f) noexcept = 0;
		virtual void DrawCone(const ConsoleRE::NiPoint3& a_origin, const ConsoleRE::NiPoint3& a_direction, float a_length, float a_angleWidth, float a_angleHeight, uint32_t a_segments, float a_duration = 0.f, uint32_t a_color = 0xFF0000FF, float a_thickness = 1.f) noexcept = 0;
		virtual void DrawCapsule(const ConsoleRE::NiPoint3& a_origin, float a_halfHeight, float a_radius, const ConsoleRE::NiQuaternion& a_rotation, float a_duration = 0.f, uint32_t a_color = 0xFF0000FF, float a_thickness = 1.f) noexcept = 0;
		...
		[[nodiscard]] virtual bool HasInfoBar(ConsoleRE::ActorHandle a_actorHandle, bool a_bFloatingOnly = false) const noexcept = 0;
	};
	...
	{
		auto pluginHandle = xUtilty::SystemWrapper::GetModuleHandle("TrueHUD.prx");

		_RequestPluginAPI requestAPIFunction = nullptr;
		sceKernelDlsym(pluginHandle, "RequestPluginAPI", (void**)&requestAPIFunction);
